...
import static com.nechunaev.sonarqube.plugins.npmaudit.measures.ExampleMetrics.FILENAME_SIZE_RATING;
...
public class ComputeSizeRating implements MeasureComputer {
	...
	public MeasureComputerDefinition define(MeasureComputerDefinitionContext def) {
		return def.newDefinitionBuilder().setInputMetrics(FILENAME_SIZE.key())
				.setOutputMetrics(FILENAME_SIZE_RATING.key()).build();
	}
